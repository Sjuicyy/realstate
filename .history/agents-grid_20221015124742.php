            ...
            <div class="card-overlay card-overlay-hover">
              <div class="card-header-d">
                <div class="card-title-d align-self-center">
                  <h3 class="title-d">
                    <a href="#" class="link-two">Aarju Silwal
                      <br> Escala</a>
                  </h3>
                </div>
              </div>
              <div class="card-body-d">
                <p class="content-d color-text-a">
                 Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis debitis, quas cupiditate, esse quidem aut consequuntur ipsa cumque aliquam quo doloribus cum, animi nulla perspiciatis provident nam? Dolores, consequatur amet.
                </p>
