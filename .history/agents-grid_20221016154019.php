        ...
        <div class="col-md-4">
          <div class="card-box-d">
            <div class="card-img-d">
              <img src="./img/aarju miss.jpg" alt="" class="img-d img-fluid">
            </div>
            <div class="card-overlay card-overlay-hover">
              <div class="card-header-d">
                <div class="card-title-d align-self-center">
                  <h3 class="title-d">
                    <a href="profile-public.php" class="link-two">Aarju Silwal
                      <br> Escala</a>
                  </h3>
                </div>
              </div>
              <div class="card-body-d">
                ...
                <div class="info-agents color-a">
                  <p>
                    <strong>Phone: </strong> +977-9867867202
                  </p>
                  <p>
                    <strong>Email: </strong> aarzusilwal@gmail.com
                  </p>
                </div>
              </div>
        ...
        <table class="table">
          ...
          <tbody>
            <tr>
              ...
              <td>
                <img src="./img/aarju miss.jpg" alt="" height="100px" width="100px">
              </td>
              <td>
                Aarju Silwal
              </td>
            ...
            <tr>
              ...
              <td>
                <div class="btn-sm btn-success text-center" style="width: 100px;">View</div>
                <div class="btn-sm btn-success text-center mt-1" style="width: 100px;">View</div>
              </td>
            </tr>
            <tr>
              <td>
