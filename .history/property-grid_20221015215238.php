        ...
        <div class="col-sm-12">
          <div class="grid-option">
            <form>
              ...
              <div class="btn float-right btn-success mb-3" id="">Change view</div>
        ...
        <table class="table">
          ...
          <tbody>
            <tr>
              ...
              <td>
                <div class="form-check">
                  <input class="form-check-input" style="accent-color: green;" type="radio" name="1" id="11" checked
                    value="1">
            ...
            <tr>
              ...
              <td>
                <div class="form-check">
                  <input class="form-check-input" style="accent-color: green;" type="radio" name="2" id="21" checked>
                  <label class="form-check-label" for="21">
                    Available
                  </label>
                </div>
                <div class="form-check">
                  <input class="form-check-input" style="accent-color: red;" type="radio" name="2" id="22">
            ...
            <tr>
              ...
              <td>
                <div class="form-check">
                  <input class="form-check-input" style="accent-color: green;" type="radio" name="3" id="31" checked>
                  <label class="form-check-label" for="31">
                    Available
                  </label>
                </div>
                <div class="form-check">
                  <input class="form-check-input" style="accent-color: red;" type="radio" name="3" id="32">
            ...
            <tr>
              ...
              <td>
                <div class="form-check">
                  <input class="form-check-input" style="accent-color: green;" type="radio" name="4" id="41" checked>
                  <label class="form-check-label" for="41">
                    Available
                  </label>
                </div>
                <div class="form-check">
                  <input class="form-check-input" style="accent-color: red;" type="radio" name="4" id="42">
            ...
            <tr>
              ...
              <td>
                <div class="form-check">
                  <input class="form-check-input" style="accent-color: green;" type="radio" name="5" id="51" checked>
                  <label class="form-check-label" for="51">
                    Available
                  </label>
                </div>
                <div class="form-check">
                  <input class="form-check-input" style="accent-color: red;" type="radio" name="5" id="52">
