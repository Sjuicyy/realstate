    ...
    <?php  $s1=$data['agent_id']; ?>
      ...
      <section class="property-single nav-arrow-b">
        ...
        <div class="col-md-12">
          ...
          <div class="row">
            <?php
            $sql = "SELECT * FROM agent where id=$s1";
            $result = $conn->query($sql);
            if ($result->num_rows > 0) {
              while ($data = mysqli_fetch_array($result)) {
            ?>
                <div class="col-md-6 col-lg-4">
                  <img src="img/Agent/<?php echo $data["image"]; ?>" alt="" class="img-fluid">
                </div>
                <div class="col-md-6 col-lg-4">
                  <div class="property-agent">
                    <h4 class="title-agent"> <?php echo $data["name"]; ?> </h4>
                    ...
                    <ul class="list-unstyled">
                      ...
                      <li class=" mt-2 d-flex justify-content-between">
                        <strong>Since:</strong>
                        <span class="color-text-a"><?php echo $data["date"]; ?></span>
                      </li>
                    </ul>
                    <div class="socials-a">
